...
- **TikTok modu:** 720p/1080p/4K kalite, 16:9 · 9:16 · 1:1 · 4:5 çerçeve, 24/30/60 fps,
  10 filtre (canlı, sıcak, siyah-beyaz, vintage, sinematik…), yeşil perdeyi silme (düz renk/yeşil ekran), zoom
- Telefondan kumanda (bilgisayarda yerel sunucu açıkken)

## Telefona kurulum
- **Android:** [ustad-teleprompter-v2.5.apk](ustad-teleprompter-v2.5.apk) dosyasını indir ve kur (WebView tabanlı, çevrimdışı).
